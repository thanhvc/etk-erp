...
public class TimeDurationTests extends GenericTestCaseBase {
  ...
  private static void assertDurationFields(String label,
                                           int years,
                                           int months,
                                           int days,
                                           int hours,
    ...
    assertEquals(label + ".equals(from/to long)",
                 duration,
                 TimeDuration.fromLong(TimeDuration.toLong(duration)));
    assertEquals(label + ".equals(from/to number)",
                 duration,
                 TimeDuration.fromNumber(TimeDuration.toLong(duration)));
    assertEquals(label + ".isZero", isZero, duration.isZero());
    if (isZero) {
      assertEquals(label + ".compareTo(zero) == 0",
                   0,
                   doCompare(TimeDuration.ZeroTimeDuration, duration));
      assertEquals(label + ".compareTo(zero) == 0",
                   0,
                   doCompare(duration, TimeDuration.ZeroTimeDuration));
    } else {
      assertNotSame(label + ".compareTo(zero) != 0",
                    0,
                    doCompare(TimeDuration.ZeroTimeDuration, duration));
      assertNotSame(label + ".compareTo(zero) != 0",
                    0,
  ...
  private static TimeDuration assertDurationLoop(String label,
                                                 Calendar right,
                                                 int years,
                                                 int months,
                                                 int days,
    ...
    String durationString = years + ":" + months + ":" + days + ":" + hours + ":" + minutes + ":"
    ...
    TimeDuration calDuration = isNegative ? new TimeDuration(right, zero) : new TimeDuration(zero,
                                                                                             right);
    assertDurationFields(label + "(parseString[0])",
                         years,
                         months,
                         days,
                         hours,
                         ...
                         isNegative,
                         false);
    assertDurationFields(label + "(parseString)",
                         years,
                         months,
                         days,
                         hours,
                         ...
                         isNegative,
                         false);
    assertDurationFields(label + "(cal)",
                         years,
                         months,
                         days,
                         hours,
    ...
    assertDurationFields(label + "(cal[add])",
                         years,
                         months,
                         days,
                         hours,
  ...
  public static void assertDuration(String label,
                                    int years,
                                    int months,
                                    int days,
                                    int hours,
    ...
    for (int i = 1; i < 12; i++) {
      lastString = assertDurationLoop(i + " " + label, right, i * years, i * months, i * days, i
          * hours, i * minutes, i * seconds, i * milliseconds, lastString, false);
    }
    lastString = null;
    for (int i = -2; i > -12; i--) {
      lastString = assertDurationLoop(i + " " + label, right, i * years, i * months, i * days, i
          * hours, i * minutes, i * seconds, i * milliseconds, lastString, true);
    }
  }
  ...
  public void testDuration() throws Exception {
    ...
    assertDurationFields("zero(same zero calendar)",
                         0,
                         0,
                         0,
                         0,
                         ...
                         false,
                         true);
    assertDurationFields("zero(same now calendar)",
                         0,
                         0,
                         0,
                         0,
                         ...
                         false,
                         true);
    assertDurationFields("zero(empty parse)",
                         0,
                         0,
                         0,
                         0,
                         ...
                         false,
                         true);
    assertDurationFields("zero(zero parse)",
                         0,
                         0,
                         0,
                         0,
                         ...
                         false,
                         true);
    assertDurationFields("zero(from null number)",
                         0,
                         0,
                         0,
                         0,
    ...
    assertDurationFields("pre-epoch elapsed time",
                         1,
                         1,
                         1,
                         1,
