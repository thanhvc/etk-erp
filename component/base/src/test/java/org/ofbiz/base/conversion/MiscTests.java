...
public class MiscTests extends GenericTestCaseBase {
  ...
  private static <S, T extends JSONResult.Indenting> void assertConversion(String label,
                                                                           String wanted,
                                                                           Class<T> targetClass,
                                                                           Object source,
                                                                           Class<S> sourceClass) throws Exception {
  ...
  public static <S> void assertPassThru(Object wanted,
                                        Class<S> sourceClass,
                                        Class<? super S> targetClass) throws Exception {
  ...
  public void testPassthru() throws Exception {
    ...
    Object[] testObjects = new Object[] { string, bigDecimal, url, arrayList, fastList, hashMap,
        fastMap, };
