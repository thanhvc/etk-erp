...
public class ComponentContainer implements Container {
      ...
      if (componentLoadConfig != null && componentLoadConfig.exists()) {
        ...
        try {
          ...
          if (componentsToLoad != null) {
            // load all of component from component directory which configured
            // in etk-components.xml
        ...
        for (String sub : fileNames) {
          try {
            ...
            if (componentPath.isDirectory() && !sub.equals("CVS") && !sub.equals(".svn")) {
              ...
              File configFile = FileUtil.getFile(componentLocation + "/etk-component.xml");
              if (configFile.exists()) {
                ComponentConfig config = null;
                try {
                  // pass null for the name, will default to the internal
                  // component name
   ...
   * system is not.
   * 
   * @param updateClasspath Tells the component loader to update the classpath,
   *          and thread classloader
