        ...
        if (fopFactory == null) {
            synchronized (ApacheFopWorker.class) {
                ...
                try {
                    ...
                    String fopPath = UtilProperties.getPropertyValue("fop.properties", "fop.path", ofbizHome + "/component/webapp/config");
                    File userConfigFile = FileUtil.getFile(fopPath + "/fop.xconf");
                    fopFactory.setUserConfig(userConfigFile);
                    String fopFontBaseUrl = UtilProperties.getPropertyValue("fop.properties", "fop.font.base.url", "file:///" + ofbizHome + "/component/webapp/config/");
