...
/**
 * This is where the service is actually invoked. 
 * Each service has an engine name assigned in its definition. 
 * This engine name is mapped via the servicesengine.xml file 
 * and is instantiated by the GenericEngineFactory when called upon. 
 * Third-party engines are supported and must follow 
 * the GenericEngine interface when implemented. 
 * See the Service Engine Configuration Guide 
 * for details on defining engines.
 */
