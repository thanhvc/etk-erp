...
public class ServiceConfigUtil implements Serializable {
  ...
  public static final String SERVICE_ENGINE_XML_FILENAME = "config/serviceengine.xml";
  
  protected static UtilCache<String, Map<String, NotificationGroup>> notificationGroupCache = 
  ...
  public static Element getXmlRootElement() throws GenericConfigException {
    ...
    return UtilXml.firstChildElement(root, "service-engine"); // only look at
                                                              // the first one
                                                              // for now
  }
