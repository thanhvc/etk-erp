...
/**
 * Partial GenericHelper implementation that is entirely memory-based, to be
 * used for simple unit testing (can't do anything beyond searches for primary
 * keys, findByOr and findByAnd).
 */
