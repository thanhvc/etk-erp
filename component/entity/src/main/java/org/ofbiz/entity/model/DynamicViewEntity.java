 ...
 * away. A special method exists on the Delegator to accept a DynamicViewEntity
 * instead of an entity-name.
 */
public class DynamicViewEntity {
  ...
  /**
   * Add an alias, full detail. All parameters can be null except entityAlias
   * and name.
   */
