...
public interface Delegator {
  ...
  /**
   * This method is a shortcut to completely clear all entity engine caches. For
   * performance reasons this should not be called very often.
   */
   ...
   * check to see if the passed GenericPK is a complete primary key. Also tries
   * to clear the corresponding all cache entry.
   * 
  ...
  /**
   * Remove a CACHED Generic Entity from the cache by its primary key. Checks to
   * see if the passed GenericPK is a complete primary key, if it is then the
   * cache line will be removed from the primaryKeyCache; if it is NOT a
   * complete primary key it will remove the cache line from the andCache. If
   * the fields map is empty, then the allCache for the entity will be cleared.
   * 
   ...
   * 
   * @param primaryKey The GenericPK to create a value in the datasource from
   * @param doCacheClear boolean that specifies whether to clear related cache
   *          entries for this primaryKey to be created
   * @return GenericValue instance containing the new instance
   */
   ...
   * 
   * @param value The GenericValue to create a value in the datasource from
   * @param doCacheClear boolean that specifies whether or not to automatically
   *          clear cache entries related to this operation
   * @return GenericValue instance containing the new instance
   */
   ...
   * then does a create in the database as normal. The reason to do it this way
   * is that it will retry and fix the sequence if somehow the sequencer is in a
   * bad state and returning a value that already exists.
   * 
   * @param value The GenericValue to create a value in the datasource from
   * @return GenericValue instance containing the new instance
   */
   ...
   * object, the the EntityCondition javadoc for more details. NOTE 20080502: 3
   * references
   * 
   * @param entityName The name of the Entity as defined in the entity XML file
   * @param whereEntityCondition The EntityCondition object that specifies how
   *          to constrain this query before any groupings are done (if this is
   *          a view entity with group-by aliases)
   * @param havingEntityCondition The EntityCondition object that specifies how
   *          to constrain this query after any groupings are done (if this is a
   ...
   * @param findOptions An instance of EntityFindOptions that specifies advanced
   *          query options. See the EntityFindOptions JavaDoc for more details.
   * @return EntityListIterator representing the result of the query: NOTE THAT
   *         THIS MUST BE CLOSED (preferably in a finally block) WHEN YOU ARE
  ...
  /**
   * Finds GenericValues by the conditions specified in the EntityCondition
   * object, the the EntityCondition javadoc for more details. NOTE 20080502: 12
   * references
   * 
   * @param entityName The name of the Entity as defined in the entity XML file
   * @param entityCondition The EntityCondition object that specifies how to
   *          constrain this query before any groupings are done (if this is a
   *          view entity with group-by aliases)
   * @param fieldsToSelect The fields of the named entity to get from the
   *          database; if empty or null all fields will be retrieved
   * @param orderBy The fields of the named entity to order the query by;
   *          optionally add a " ASC" for ascending or " DESC" for descending
   * @param findOptions An instance of EntityFindOptions that specifies advanced
   *          query options. See the EntityFindOptions JavaDoc for more details.
  ...
  /**
   * Finds GenericValues by the conditions specified in the EntityCondition
   * object, the the EntityCondition javadoc for more details. NOTE 20080502: 9
   * references
   * 
   * @param dynamicViewEntity The DynamicViewEntity to use for the entity model
   *          for this query; generally created on the fly for limited use
   * @param whereEntityCondition The EntityCondition object that specifies how
   *          to constrain this query before any groupings are done (if this is
   *          a view entity with group-by aliases)
   * @param havingEntityCondition The EntityCondition object that specifies how
   ...
   *          query options. See the EntityFindOptions JavaDoc for more details.
   * @return EntityListIterator representing the result of the query: NOTE THAT
   *         THIS MUST BE CLOSED WHEN YOU ARE DONE WITH IT, AND DON'T LEAVE IT
  ...
  /**
   * Gets a field type instance by name from the helper that corresponds to the
   * specified entity
   * 
   ...
   * 
   * @param entity The entity
   * @return Collection of field type names from the helper that corresponds to
   ...
   * @return String with the helper name that corresponds to this delegator and
   ...
   * @return GenericHelper that corresponds to this delegator and the specified
   *         entity
   */
  ...
  /**
   * Gets the instance of ModelEntity that corresponds to this delegator and the
   * specified entityName
   * 
   ...
   * across another Relation. Helps to get related Values in a multi-to-multi
   * relationship. NOTE 20080502: 3 references
   * 
   ...
   * @param relationNameTwo String containing the relation name for second
   *          relation
   ...
   *          sequence will be incremented by 1, otherwise the current sequence
   *          ID will be incremented by a value between 1 and staggerMax
  ...
  /**
   * Creates a Entity in the form of a GenericValue without persisting it; only
   * valid fields will be pulled from the fields Map
   */
  ...
  /**
   * Remove the Entities from the List from the persistent store. <br/>
   * The List contains GenericEntity objects, can be either GenericPK or
   * GenericValue. <br/>
   * If a certain entity contains a complete primary key, the entity in the
   * datasource corresponding to that primary key will be removed, this is like
   * a removeByPrimary Key. <br/>
   * On the other hand, if a certain entity is an incomplete or non primary key,
   * if will behave like the removeByAnd method. <br/>
   * These updates all happen in one transaction, so they will either all
   * succeed or all fail, if the data source supports transactions.
   * 
   * @param dummyPKs Collection of GenericEntity instances containing the
   *          entities or by and fields to remove
  ...
  /**
   * Removes/deletes Generic Entity records found by all of the specified fields
   * (ie: combined using AND)
   * 
   * @param entityName The Name of the Entity as defined in the entity XML file
   * @param doCacheClear boolean that specifies whether to clear cache entries
   *          for this value to be removed
   * @param fields The fields of the named entity to query by with their
   *          corresponding values
   * @return int representing number of rows effected by this operation
   */
   ...
   * @param primaryKey The primary key of the entity to remove.
   * @param doCacheClear boolean that specifies whether to clear cache entries
   *          for this primaryKey to be removed
   * @return int representing number of rows effected by this operation
   */
  ...
  /**
   * Look at existing values for a sub-entity with a sequenced secondary ID, and
   ...
   * store. <br/>
   * This is different than the normal store method in that the store method
   * only does an update, while the storeAll method checks to see if each entity
   * exists, then either does an insert or an update as appropriate. <br/>
   * These updates all happen in one transaction, so they will either all
   * succeed or all fail, if the data source supports transactions. This is just
   ...
   * @param doCacheClear boolean that specifies whether or not to automatically
   *          clear cache entries related to this operation
   * @param createDummyFks boolean that specifies whether or not to
   *          automatically create "dummy" place holder FKs
   * @return int representing number of rows effected by this operation
   */
   ...
   * 
   * @return boolean true if this delegator uses a Distributed Cache Clear
   *         mechanism
   */
