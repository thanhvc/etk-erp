...
public class ModelRelation extends ModelChild {
  ...
  /**
   * keyMaps defining how to lookup the relatedTable using columns from this
   * table
   */
  ...
  public ModelKeyMap findKeyMap(String fieldName) {
    for (ModelKeyMap keyMap : keyMaps) {
      if (keyMap.fieldName.equals(fieldName))
        return keyMap;
    }
    return null;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!otherRel.type.equals(this.type))
      return false;
    if (!otherRel.title.equals(this.title))
      return false;
    if (!otherRel.relEntityName.equals(this.relEntityName))
      return false;
    ...
    if (!thisKeyNames.containsAll(otherKeyNames))
      return false;
    if (!otherKeyNames.containsAll(thisKeyNames))
      return false;
