...
public class ModelGroupReader implements Serializable {
  ...
  /**
   * Gets a group name based on a definition from the specified XML Entity Group
   * descriptor file.
   * 
  ...
  /**
   * Creates a Set with all of the groupNames defined in the specified XML
   * Entity Group Descriptor file.
   * 
