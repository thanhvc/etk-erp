...
/**
 * Represents the conditions to be used to constrain a query <br/>
 ...
 * EntityConditions
 * <li>EntityFieldMap: a map of fields where the field (key) equals the value,
 * combined with the operator specified
 * </ul>
 * These can be used in various combinations using the EntityConditionList and
 * EntityExpr objects.
 */
...
public abstract class EntityConditionBase implements Serializable {
  ...
  protected String getColName(Map<String, String> tableAliases, ModelEntity modelEntity, ModelField modelField, String fieldName, boolean includeTableNamePrefix, DatasourceInfo datasourceInfo) {
    ...
    // if this is a view entity and we are configured to alias the views, use
    // the alias here instead of the composite (ie table.column) field name
