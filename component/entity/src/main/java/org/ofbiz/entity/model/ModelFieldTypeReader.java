...
public class ModelFieldTypeReader implements Serializable {
  ...
  /**
   * Gets an FieldType object based on a definition from the specified XML
   * FieldType descriptor file.
   * 
   * @param fieldTypeName The fieldTypeName of the FieldType definition to use.
   * @return An FieldType object describing the specified fieldType of the
