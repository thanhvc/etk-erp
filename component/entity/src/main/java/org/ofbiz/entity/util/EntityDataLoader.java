...
public class EntityDataLoader {
  ...
  public static <E> List<URL> getUrlList(String helperName,
  ...
  public static int loadData(URL dataUrl,
                             String helperName,
                             Delegator delegator,
                             List<Object> errorMessages) throws GenericEntityException {
  ...
  public static int loadData(URL dataUrl,
                             ...
                             int txTimeout) throws GenericEntityException {
  ...
  public static int loadData(URL dataUrl,
                             ...
                             boolean dummyFks,
                             boolean maintainTxs,
                             boolean tryInsert) throws GenericEntityException {
    int rowsChanged = 0;
    ...
    Debug.logVerbose("[install.loadData] Loading XML Resource: \"" + dataUrl.toExternalForm()
        + "\"", module);

    try {
      /*
       * The OLD way List toBeStored = delegator.readXmlDocument(url);
       * delegator.storeAll(toBeStored); rowsChanged += toBeStored.size();
       */
      ...
      String xmlError = "[install.loadData]: Error loading XML Resource \""
    ...
    for (String entityName : reader.getEntityNames()) {
      ...
      if (baseName != null) {
        try {
          ...
          toBeStored.add(delegator.makeValue("SecurityPermission", "permissionId", baseName
              + "_ADMIN", "description", "Permission to Administer a " + entity.getEntityName()
              + " entity."));
          toBeStored.add(delegator.makeValue("SecurityGroupPermission",
                                             "groupId",
                                             "FULLADMIN",
                                             "permissionId",
                                             baseName + "_ADMIN"));
          ...
          errorMessages.add("[install.generateData] ERROR: Failed Security Generation for entity \""
              + baseName + "\"");
        }

        /*
         * toStore.add(delegator.makeValue("SecurityPermission", "permissionId",
         * baseName + "_VIEW", "description", "Permission to View a " +
         * entity.getEntityName() + " entity."));
         * toStore.add(delegator.makeValue("SecurityPermission", "permissionId",
         * baseName + "_CREATE", "description", "Permission to Create a " +
         * entity.getEntityName() + " entity."));
         * toStore.add(delegator.makeValue("SecurityPermission", "permissionId",
         * baseName + "_UPDATE", "description", "Permission to Update a " +
         * entity.getEntityName() + " entity."));
         * toStore.add(delegator.makeValue("SecurityPermission", "permissionId",
         * baseName + "_DELETE", "description", "Permission to Delete a " +
         * entity.getEntityName() + " entity."));
         * toStore.add(delegator.makeValue("SecurityGroupPermission", "groupId",
         * "FLEXADMIN", "permissionId", baseName + "_VIEW"));
         * toStore.add(delegator.makeValue("SecurityGroupPermission", "groupId",
         * "FLEXADMIN", "permissionId", baseName + "_CREATE"));
         * toStore.add(delegator.makeValue("SecurityGroupPermission", "groupId",
         * "FLEXADMIN", "permissionId", baseName + "_UPDATE"));
         * toStore.add(delegator.makeValue("SecurityGroupPermission", "groupId",
         * "FLEXADMIN", "permissionId", baseName + "_DELETE"));
         */
      }
    }
