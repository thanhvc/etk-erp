...
public class GenericHelperDAO implements GenericHelper {
   ...
   * @return List of GenericValue objects corresponding to the passed primaryKey
   *         objects
   */
   ...
   * optionally adding missing entities or fields on the server
   * 
