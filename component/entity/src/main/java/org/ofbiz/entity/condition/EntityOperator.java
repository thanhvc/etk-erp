...
public abstract class EntityOperator<L, R, T> extends EntityConditionBase {
  ...
  public static final EntityComparisonOperator<?, ?> EQUALS = new ComparableEntityComparisonOperator<Object>(ID_EQUALS, "=") {
    ...
    protected void makeRHSWhereString(ModelEntity entity, List<EntityConditionParam> entityConditionParams, StringBuilder sb, ModelField field, Object rhs, DatasourceInfo datasourceInfo) {
      if (rhs == null || rhs == GenericEntity.NULL_FIELD) {
        ...
        // Debug.logInfo("makeRHSWhereString: field not null, doing super: " +
        // field.getName() + ", type: " + rhs.getClass().getName() + ", value: "
        // + rhs, module);
  ...
  public static final EntityComparisonOperator<?, ?> IN = new CollectionEntityComparisonOperator<Object>(ID_IN, "IN") {
    ...
    @Override
    protected void makeRHSWhereStringValue(ModelEntity entity, List<EntityConditionParam> entityConditionParams, StringBuilder sb, ModelField field, Collection<Comparable<Object>> rhs, DatasourceInfo datasourceInfo) {
  ...
  /*
   * public T eval(Delegator delegator, Map<String, ? extends Object> map,
   * Object lhs, Object rhs) { return castBoolean(mapMatches(delegator, map,
   * lhs, rhs)); }
   */
