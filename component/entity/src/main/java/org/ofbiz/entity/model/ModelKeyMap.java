...
public class ModelKeyMap implements java.io.Serializable {
  ...
  public ModelKeyMap(Element keyMapElement) {
    ...
    // if no relFieldName is specified, use the fieldName; this is convenient
    // for when they are named the same, which is often the case
  ...
  public boolean equals(Object other) {
    ...
    if (!otherKeyMap.fieldName.equals(this.fieldName))
      return false;
    if (!otherKeyMap.relFieldName.equals(this.relFieldName))
      return false;
