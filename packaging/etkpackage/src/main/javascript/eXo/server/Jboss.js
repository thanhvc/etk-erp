...
function Jboss(jbossHome) {
  ...
  this.deployLibDir = this.serverHome + "/server/default/deploy/gatein.sar/lib";
...
Jboss.prototype.preDeploy = function(product) {
  product.addDependencies(new Project("commons-pool", "commons-pool", "jar", "1.5.5"));
  product.addDependencies(new Project("commons-dbcp", "commons-dbcp", "jar", "1.2.2"));
